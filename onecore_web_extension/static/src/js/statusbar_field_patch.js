...
patch(StatusBarField.prototype, {
    getAllItems() {
        ...
        if (this.field.type === "many2one") {
            ...
            const shouldDisable = record.model.config.resModel === "maintenance.request" && record.data.user_is_external_contractor;
            ...
            return this.specialData.data.map((option) => ({
                ...
                isDisabled:
                    shouldDisable &&
                    (option.display_name === "Avslutad" || currentStageName === "Avslutad" || currentStageName === "Utförd"),
            }));
        } else {
            // Selection
