...
class TestEquipmentMulticompany(TransactionCase):
    ...
    def test_00_equipment_multicompany_user(self):
        ...
        # Use full models
        Equipment = self.env['onecore.maintenance.equipment']
        MaintenanceRequest = self.env['onecore.maintenance.request']
        Category = self.env['onecore.maintenance.equipment.category']
        ResUsers = self.env['res.users']
        ResCompany = self.env['res.company']
        MaintenanceTeam = self.env['onecore.maintenance.team']
