...
class TestEquipment(TransactionCase):
    ...
    def setUp(self):
        ...
        self.equipment = self.env['onecore.maintenance.equipment']
        self.maintenance_request = self.env['onecore.maintenance.request']
        self.res_users = self.env['res.users']
        self.maintenance_team = self.env['onecore.maintenance.team']
        ...
        self.equipment_monitor = self.env['onecore.maintenance.equipment.category'].create({
            'name': 'Monitors - Test',
        })
