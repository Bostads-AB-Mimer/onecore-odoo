...
class StaircaseFieldsMixin(models.AbstractModel):
    ...
    staircase_option_id = fields.Many2one("maintenance.staircase.option", store=False, string="Trappuppgång (sökval)")
    staircase_id = fields.Many2one("maintenance.staircase", store=True, string="Trappuppgång")
    staircase_name = fields.Char("Trappuppgångsnamn", related="staircase_id.name", depends=["staircase_id"])
