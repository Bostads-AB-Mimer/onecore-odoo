...
class RentalPropertyFieldsMixin(models.AbstractModel):
    ...
    estate_code = fields.Char("Hyresobjektets fastighetsnummer", related="rental_property_id.estate_code", depends=["rental_property_id"])
    estate = fields.Char("Hyresobjektets fastighet", related="rental_property_id.estate", depends=["rental_property_id"])
