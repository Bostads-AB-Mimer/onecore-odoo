...
import { TenantComposer } from "./tenant_composer";
 ...
 */
export class TenantChatter extends Chatter {
    static template = "onecore_mail_extension.TenantChatter";
    static components = {
        AttachmentList,
        Dropdown,
        Thread,
    ...
    setup() {
        console.log("TenantChatter setup");
