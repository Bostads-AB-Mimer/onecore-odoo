 ...
 * @property {import("models").TenantComposer} tenantComposer
 ...
 */
export class TenantComposer extends Composer {
    static components = {
        AttachmentList,
        Picker,
        FileUploader,
    ...
    setup() {
        console.log("ONECORE this.props", this.props);
    ...
    get placeholder() {
        if (this.props.placeholder) {
            ...
            // TODO: placeholder="Skriv ett meddelande till hyresgäst"
    ...
    async _sendMessage(value, postData) {
        ...
        console.log("ONECore thread", thread);
...
TenantComposer.template = "onecore_mail_extension.TenantComposer";
