...
export class AccordionController extends Component {
  setup() {
    this.actionService = useService('action')
    this.dialog = useService('dialog')
    const { Model, archInfo } = this.props

    class AccordionSampleModel extends Model {
      setup() {
...
AccordionController.template = `web.AccordionView`
AccordionController.components = {
  Layout,
  AccordionRenderer,
